...
- PubPeer plugin for detecting issues with papers
...
### 🎯 **Claude (claude.ai)** - HIGHLY RECOMMENDED FOR YOUR COURSE
...
- Explain complex mechanisms (e.g., "Explain the complement cascade")
...
### 🎯 **ChatGPT (chat.openai.com)** - ALSO RECOMMENDED
...
**Teaching Use Cases:**
- Quickly understand "what does the research say about X?"
...
- Describe what's in scientific images
- Suggest quantification approaches
- Identify potential artifacts
- Compare before/after images

**Teaching Use Cases:**
- "What cell type is this?" (from microscopy)
- "Count the colonies in this plate image"
- "What's wrong with this Western blot?"
...
- Python code is generated but you don't need to write it
...
## Recommended Tool Stack for Your Course
...
6. **Claude Pro or ChatGPT Plus** - Better image analysis, longer responses
7. **Grammarly Premium** - Writing improvement
8. **Consensus** - Research synthesis

### **Specialized Tier** (Field-specific)
9. **BenchSci** - If doing wet lab work
10. **GitHub Copilot** - If coding is important
...
- Instructor provides AI-generated "facts" about biomedical topics
